...
cellRule = {'conds': {'cellType': 'PYR'},  'secs': {}} 	# cell rule dict #secs black dictionary that you can fill with cell morphology info
...
netParams.stimSourceParams['bkg'] = {'type': 'NetStim', 'rate': 10, 'noise': 0.5} ## stimulation with a bit of noise 
